...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
          "bg-primary-600 text-white shadow-md hover:bg-primary-700 focus-visible:ring-primary-400",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-red-600",
        outline:
          "border border-input bg-background shadow-sm hover:bg-primary-50 hover:text-primary-700 hover:border-primary-300",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-primary-100",
        ghost:
          "hover:bg-primary-50 hover:text-primary-700",
        link:
          "text-primary-600 underline-offset-4 hover:underline hover:text-primary-800",
      },
      size: {
